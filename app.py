...
from answers.Launching_and_configuring_an_Amazon_EC2_instance_Activity_Guide import CreateVPC
...
CreateVPC(app, "LaunchingAndConfiguringAnAmazonEC2InstanceActivityGuide", env=env)
